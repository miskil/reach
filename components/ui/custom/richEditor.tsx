  ...
  (
    ...
    */
    useEffect(() => {
      ...
      // Only update content when id changes
      if (editor && prevIdRef.current !== id) {
        if (initialContent !== undefined) {
          editor.innerHTML = initialContent;
        }
        if (initialStyle) {
          Object.assign(editor.style, initialStyle);
        }
        prevIdRef.current = id; // Update previous ID
      }
    }, [id, initialContent, initialStyle]);
